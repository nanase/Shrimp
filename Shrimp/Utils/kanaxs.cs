...
// 拡張メソッド化: Tomona Nanase <nanase@users.noreply.github.com>
...
namespace System
{
    ...
    public static class KanaEx
    {
        ...
        /// </remarks>
        public static string ToHankakuKana ( this  string str )
        {
            if ( str == null || str.Length == 0 )
            {
                return str;
        ...
        /// </remarks>
        public static string ToZenkakuKana ( this  string str )
        {
            if ( str == null || str.Length == 0 )
            {
                return str;
        ...
        /// </remarks>
        public static string ToPadding ( this  string str )
        {
            if ( str == null || str.Length == 0 )
            {
                return str;
