...
namespace Shrimp.ControlParts.Timeline.Draw
{
    ...
    public class TweetDraw : TimelineCells, IDisposable
    {
                                    ...
                                    Brush DefaultBackBrush = null)
        {
            ...
            {
                g.DrawLine ( new Pen ( Color.FromArgb ( 57, 57, 57 ) ), new Point ( 0, p.CellRect.Top ), new Point ( maxWidth, p.CellRect.Top ) );
                g.DrawLine ( new Pen ( Color.FromArgb ( 67, 67, 69 ) ), new Point ( 0, p.CellRect.Top + 1), new Point ( maxWidth, p.CellRect.Top + 1 ) );
            }
            ...
            if ( Setting.Colors.IsShootingStar )
            {
                g.DrawLine ( new Pen ( Color.FromArgb ( 25, 25, 25 ) ), new Point ( offset_start_x, p.CellRect.Bottom - 1 ), new Point ( maxWidth - offset_start_x, p.CellRect.Bottom - 1 ) );
                g.DrawLine ( new Pen ( Color.FromArgb ( 12, 12, 12 ) ), new Point ( offset_start_x, p.CellRect.Bottom), new Point ( maxWidth -offset_start_x, p.CellRect.Bottom ) );
            }
            this.EndLayout();
            return true;
        }
